...
public class PawnMoveTests {
    ...
    //On a chess.pawn's first move (from the starting position), they can move 2 spaces instead of just 1
    @Test
    ...
    public void doubleMoveBlocked() {
        ...
        //valid move from white chess.pawn
