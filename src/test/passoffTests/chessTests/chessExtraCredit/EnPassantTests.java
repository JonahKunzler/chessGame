 ...
 * En Passant is a situational move in chess taken directly after your opponent has double moved a chess.pawn
 * If their chess.pawn moves next to one of your pawns, so it passes where your chess.pawn could have captured it, you
 * may capture their chess.pawn with your chess.pawn as if they had only moved a single space. You may only take this move
 * if you do so the turn directly following the pawns double move. This is as if you had caught their
 * chess.pawn "in passing", or translated to French: "En Passant".
 */
public class EnPassantTests {
    ...
    public void enPassantWhiteRight() throws InvalidMoveException {
        ...
        //black chess.pawn that will double move
        ...
        //make sure chess.pawn has En Passant move
        ...
        Assertions.assertNull(game.getBoard().getPiece(TestFactory.getNewPosition(5, 3)),
                "After En Passant move, piece still present at taken chess.pawn position");
        ...
        Assertions.assertEquals(ChessPiece.PieceType.PAWN, foundPawn.getPieceType(),
                "Found piece at chess.pawn's position is not a chess.pawn");
        Assertions.assertEquals(ChessGame.TeamColor.WHITE, foundPawn.getTeamColor(),
                "Found piece at chess.pawn's position is the wrong team color");
    }
    ...
    public void enPassantBlackRight() throws InvalidMoveException {
        ...
        //white chess.pawn that will double move
    ...
    public void missedEnPassant() throws InvalidMoveException {
        ...
        //white chess.pawn on board
        ChessPiece pawn = TestFactory.getNewPiece(ChessGame.TeamColor.WHITE, ChessPiece.PieceType.PAWN);
        ChessPosition position = TestFactory.getNewPosition(5, 2);
        chessBoard.addPiece(position, pawn);

        //black chess.pawn that double moves
        chessBoard.addPiece(TestFactory.getNewPosition(7, 3),
                TestFactory.getNewPiece(ChessGame.TeamColor.BLACK, ChessPiece.PieceType.PAWN));
        ...
        //make sure chess.pawn cannot do En Passant move
