...
public class WebSocketFacade extends Endpoint{
  ...
  public void joinPlayer(String authToken, ChessGame.TeamColor color, int gameID) throws ResponseException {
    try {
      var action = new joinPlayerCommand(authToken, color, gameID);
