...
public interface ChessMove {
    ...
    /**
     * Gets the type of piece to promote a chess.pawn to if chess.pawn promotion is part of this
     * chess move
     * 
     * @return Type of piece to promote a chess.pawn to, or null if no promotion
     */
